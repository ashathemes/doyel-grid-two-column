...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'doyel-grid-two-column' ); ?></a>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<button class="screen-reader-text menu-close"><?php esc_html_e( 'Close Menu', 'doyel-grid-two-column' ); ?></button>
					<div class="mainmenu">
						<?php
							wp_nav_menu( array(
